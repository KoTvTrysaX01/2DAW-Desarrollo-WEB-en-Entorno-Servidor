<?php
    // Array asociativo con los datos de usuarios
	$usuarios = [
                    [
                        'id' => 1,
                        'nombre' => 'Maria Garcia',
