    ...
    <section class="cta-section text-center">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <a href="index.php?page=contacto" class="btn btn-light btn-lg me-3">Contactar ahora</a>
          <a href="index.php?page=alquiler" class="btn btn-outline-light btn-lg">Ver vehículos</a>
        </div>
      </div>
    </section>
