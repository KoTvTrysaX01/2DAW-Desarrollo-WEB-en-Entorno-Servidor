	...
	<script>
		$(document).ready(function() {
			...
			$('.btn-edit').click(function() {
				...
				// alert("Editar "+id);
				$(location).attr('href', './content/electronica_form.php?edit=' + id);
			});
			...
			$('.btn-add').click(function() {
				$(location).attr('href', './content/electronica_form.php');
			});
			...
			$('#btn-confirmDelete').click(function() {
				...
				//  deleteElement(registroDelete);
				//  $(location).attr('href', '<?php //echo "index.php?page=electronica"; ?>');
