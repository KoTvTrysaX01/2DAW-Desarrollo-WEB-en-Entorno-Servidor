...
public class EmpleadoController {
    ...
    // http://localhost:8080/bdempleados/static-noexiste = gestionado por
    // GlobalExceptionHandler
    // http://localhost:8080/bdempleados/api/api-noexiste = gestionado por
    // GlobalExceptionHandler
    // ***************************************************************************
    // CONSULTAS
    // ***************************************************************************
    ...
    // SWAGGER
    @Operation(summary = "Obtener todos los empleados", description = "Retorna una lista con todos los empleados disponibles")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Empleados obtenidos con éxito")
    })
    ...
    // SWAGGER
    @Operation(summary = "Obtener empleado por ID", description = "Retorna un empleado específico basado en su ID")
    @ApiResponses(value = {
    ...
    // SWAGGER
    @Operation(summary = "Obtener empleados de un departamento", description = "Retorna una lista con todos los empleados de un departamento especifico")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Empleados obtenidos con éxito")
    })
    ...
    // SWAGGER
    @Operation(summary = "Obtener empleado por letras en su nombre", description = "Retorna un empleado específico basado en su ID")
    @ApiResponses(value = {
    ...
    // SWAGGER
    @Operation(summary = "Obtener el número de empleados existentes", description = "Retorna la cantidad de empleados")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Número de empleados obtenidos con éxito", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = """
                    {
                      "empleados": "integer"
                    }
                    """)))
