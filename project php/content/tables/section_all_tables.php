<style>
    ...
    .mails {
        background-color: rgba(94, 255, 236, 1);
        color: rgba(0, 25, 217, 1);
    }

    .mails:hover {
        color: rgba(94, 255, 236, 1);
        background-color: rgba(0, 25, 217, 1);
    }
...
<div class="container-grid">
    ...
    <div class="col mails" onclick="location.href='tables.php?category=mails'">mails</div>
